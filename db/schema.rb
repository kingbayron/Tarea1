...
ActiveRecord::Schema.define(version: 2019_10_06_232228) do
  ...
  create_table "asignaturas", force: :cascade do |t|
    ...
    t.index ["curso_id"], name: "index_asignaturas_on_curso_id"
    t.index ["user_id"], name: "index_asignaturas_on_user_id"
  end
  ...
  create_table "evaluacions", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_evaluacions_on_user_id"
  end
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["asignatura_id"], name: "index_posts_on_asignatura_id"
  ...
  add_foreign_key "asignaturas", "users"
  add_foreign_key "comentarios", "posts"
  add_foreign_key "comentarios", "users"
  add_foreign_key "evaluacions", "users"

...
class EvaluacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluacion" do
    assert_difference('Evaluacion.count') do
      post evaluacions_url, params: { evaluacion: { comentario: @evaluacion.comentario, nota: @evaluacion.nota, user_id: @evaluacion.user_id } }
    end
  ...
  test "should update evaluacion" do
    patch evaluacion_url(@evaluacion), params: { evaluacion: { comentario: @evaluacion.comentario, nota: @evaluacion.nota, user_id: @evaluacion.user_id } }
